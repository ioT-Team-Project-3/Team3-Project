...
public:
    ...
    void quiz(int first, int second, int answer)
    {
        string s1 = " Left:O Right:X ";
        string s2 = quizInt(first) + " + " + quizInt(second) + " = " + quizInt(answer);
        print(s1 + s2);
    }
